...
follow.  These two tools prevent the developer from breaking existing features
...
actuall add various components to the code.  It is intended that these will be
