...
int ReadParameterFile(FILE *fptr, TopGridData &MetaData, float *Initialdt)
{
  ...
  while ((fgets(line, MAX_LINE_LENGTH, fptr) != NULL) 
    ...
    ret += sscanf(line, "hi_ph_avg_cross_section = %"FSYM, &grackle_data.hi_ph_avg_cross_section);
    ret += sscanf(line, "hei_ph_avg_cross_section = %"FSYM,&grackle_data.hei_ph_avg_cross_section);
    ret += sscanf(line, "heii_ph_avg_cross_section = %"FSYM, &grackle_data.heii_ph_avg_cross_section);
    ret += sscanf(line, "hi_pi_avg_cross_section = %"FSYM, &grackle_data.hi_pi_avg_cross_section);
    ret += sscanf(line, "hei_pi_avg_cross_section = %"FSYM, &grackle_data.hei_pi_avg_cross_section);
    ret += sscanf(line, "heii_pi_avg_cross_section = %"FSYM, &grackle_data.heii_pi_avg_cross_section);
    ...
    ret += sscanf(line, "IndividualStarFeedbackStencilSize = %"ISYM,
