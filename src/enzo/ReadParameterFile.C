...
int ReadParameterFile(FILE *fptr, TopGridData &MetaData, float *Initialdt)
{
  ...
  while ((fgets(line, MAX_LINE_LENGTH, fptr) != NULL) 
    ...
    ret += sscanf(line, "StellarYieldsAtomicNumbers = %"ISYM" %"ISYM" %"ISYM" %"ISYM" %"ISYM" %"ISYM" %"ISYM" %"ISYM" %"ISYM" %"ISYM " %"ISYM" %"ISYM " %"ISYM " %"ISYM,
                  ...
                  StellarYieldsAtomicNumbers+12, StellarYieldsAtomicNumbers+13);
