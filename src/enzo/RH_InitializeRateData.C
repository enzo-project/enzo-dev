...
int InitializeRateData(FLOAT Time)
{
  ...
  /* Set radiation parameters (ignored if RadiationFieldType = 10 or 11).
     Note: this parameters are currently hard-coded here, but should be
           read in as run-time parameters. The first two (alpha0, f3) are
           now done this way. */
  ...
  /* Set CoolData parameters.  These should be input and not hard-coded. */
