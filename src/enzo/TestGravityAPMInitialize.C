                             ...
                             TopGridData &MetaData)
{
  ...
  if (TopGrid.GridData->TestGravityAPMInitializeGrid(TestGravityDensity,
                                                     TestGravityNumberOfParticles,
                                                     TestGravityCentralParticlePosition,
                                                     TestGravityUseBaryons) == FAIL)
  {
    ENZO_FAIL("Error in TestGravityAPMInitializeGrid.\n");
  }
  ...
  if (NumberOfSubgridZones[0] > 0)
  {
    ...
    if (Subgrid->GridData->TestGravityAPMInitializeGrid(TestGravityDensity * POW(float(RefineBy), MetaData.TopGridRank),
