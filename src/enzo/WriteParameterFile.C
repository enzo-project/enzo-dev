...
//  fprintf(fptr, "LW_factor                   = %"ESYM"\n", grackle_data->LW_factor);
  ...
  fprintf(fptr, "IndivdualStarTrackAGBMetalDensity = %"ISYM"\n", IndividualStarTrackAGBMetalDensity);
  ...
  fprintf(fptr, "IndividualStarOTRadiationMethod = %"ISYM"\n", IndividualStarOTRadiationMethod);
  fprintf(fptr, "IndividualStarApproximateOTRadiation = %"ISYM"\n", IndividualStarApproximateOTRadiation);
  fprintf(fptr, "IndividualStarApproximateOTThreshold = %"FSYM"\n", IndividualStarApproximateOTThreshold);
