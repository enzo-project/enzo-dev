/***********************************************************************
/
/  GRID CLASS (COMPUTE TIME STEP RATIO)
/
...
// Compute the ratio of the timestep from all the constrains for this grid 
// to the conduction timestep.
//
...
float grid::ComputeTimeStepRatio()
{
