...
int grid::zEulerSweep_vg(int j, int NumberOfSubgrids, fluxes *SubgridFluxes[], 
  ...
  */
  ...
  if (PPMDiffusionParameter != 0 || PPMFlatteningParameter != 0)
    FORTRAN_NAME(calcdiss_vg)(dslice, eslice, uslice, BaryonField[Vel1Num],
			   ...
			   &dtFixed, gslice, &PPMDiffusionParameter,
  ...
  if (ReconstructionMethod == PPM)
    FORTRAN_NAME(inteuler_vg)(dslice, pslice, &GravityOn, grslice, geslice, uslice,
  ...
  case TwoShock:
    FORTRAN_NAME(twoshock_vg)(dls, drs, pls, prs, uls, urs,
			   &GridDimension[2], &GridDimension[0],
			   &is, &ie_p1, &js, &je,
			   &dtFixed, gslice, &MinimumPressure, &PressureFree,
			   pbar, ubar, &GravityOn, grslice,
			   &DualEnergyFormalism, &DualEnergyFormalismEta1);
    
    FORTRAN_NAME(flux_twoshock_vg)(dslice, eslice, geslice, uslice, vslice, wslice,
				CellWidthTemp[2], diffcoef, 
				&GridDimension[2], &GridDimension[0],
				&is, &ie, &js, &je, &dtFixed, gslice,
  ...
  case HLL:
    FORTRAN_NAME(flux_hll_vg)(dslice, eslice, geslice, uslice, vslice, wslice,
			   CellWidthTemp[2], diffcoef, 
			   &GridDimension[2], &GridDimension[0],
			   &is, &ie, &js, &je, &dtFixed, gslice,
			   &PPMDiffusionParameter, &DualEnergyFormalism,
  ...
  case HLLC:
    FORTRAN_NAME(flux_hllc_vg)(dslice, eslice, geslice, uslice, vslice, wslice,
			    CellWidthTemp[2], diffcoef, 
			    &GridDimension[2], &GridDimension[0],
			    &is, &ie, &js, &je, &dtFixed, gslice,
			    &PPMDiffusionParameter, &DualEnergyFormalism,
  ...
  FORTRAN_NAME(euler_vg)(dslice, eslice, grslice, geslice, uslice, vslice, wslice,
		      CellWidthTemp[2], diffcoef, 
		      &GridDimension[2], &GridDimension[0], 
		      &is, &ie, &js, &je, &dtFixed, gslice, 
