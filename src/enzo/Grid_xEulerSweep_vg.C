...
int grid::xEulerSweep_vg(int k, int NumberOfSubgrids, fluxes *SubgridFluxes[], 
		      ...
		      int GravityOn, int NumberOfColours, int colnum[], float *pressure, float *gamma)
{
  ...
  */
  ...
  if (PPMDiffusionParameter != 0 || PPMFlatteningParameter != 0)
    FORTRAN_NAME(calcdiss_vg)(dslice, eslice, uslice, BaryonField[Vel2Num],
