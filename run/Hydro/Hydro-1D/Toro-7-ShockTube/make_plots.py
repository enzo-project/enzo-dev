...
### some more filenames
exact_solution_filename = './Toro-7-ShockTube_t=2.0_exact.txt'
...
error_label(norm['Density'], maxnorm['Density'], 0.1, 1.1)
...
pylab.axis([0,1,0.0,0.2])
pylab.xlabel('Position')
pylab.ylabel('Velocity')

error_label(norm['x-velocity'], maxnorm['x-velocity'], 0.1, 0.18)
...
error_label(norm['InternalEnergy'], maxnorm['InternalEnergy'], 0.1, 2.5)
