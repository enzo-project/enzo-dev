...
### define problem name
problem_name = 'Toro-1-ShockTube'
#problem_name = 'Toro-1-ShockTubeAMR'
...
### some more filenames
exact_solution_filename = './Toro-1-ShockTube_t=0.2_exact.txt'
...
pylab.axis([0,1,-0.1,1.6])
pylab.xlabel('Position')
pylab.ylabel('Velocity')

error_label(norm['x-velocity'], maxnorm['x-velocity'], 0.1, 0.4)
...
pylab.axis([0,1,1.8,3.8])
pylab.xlabel('Position')
pylab.ylabel('Internal Energy')

error_label(norm['InternalEnergy'], maxnorm['InternalEnergy'], 0.05, 3.6)
