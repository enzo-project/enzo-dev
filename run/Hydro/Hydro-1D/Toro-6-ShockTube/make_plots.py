...
### some more filenames
exact_solution_filename = './Toro-6-ShockTube_t=2.0_exact.txt'
...
pylab.axis([0,1,0.9,1.5])
pylab.xlabel('Position')
pylab.ylabel('Density')

error_label(norm['Density'], maxnorm['Density'], 0.51, 1.45)
...
pylab.axis([0,1,-0.1,0.1])
pylab.xlabel('Position')
pylab.ylabel('Velocity')

error_label(norm['x-velocity'], maxnorm['x-velocity'], 0.1, 0.08)
...
pylab.axis([0,1,0.9,1.1])
pylab.xlabel('Position')
pylab.ylabel('Pressure')

error_label(norm['Pressure'], maxnorm['Pressure'], 0.1, 1.08)
...
pylab.axis([0,1,1.6,2.6])
pylab.xlabel('Position')
pylab.ylabel('Internal Energy')

error_label(norm['InternalEnergy'], maxnorm['InternalEnergy'], 0.51, 1.9)
